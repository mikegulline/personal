...
To collect as much user data as possible in your Next.js application, you can extract various pieces of information from the NextRequest object. This includes the user's IP address, user agent (browser information), and possibly geo-location data if available.

Here's how you can enhance your processCompany function to gather more detailed user data:

    IP Address: You can get this from the request headers.
    User Agent: This will give you information about the user's browser.
    Geo-location: If using Vercel, the x-vercel-ip-country, x-vercel-ip-city, and similar headers can provide location data.
    Screen Size: This can be collected client-side using JavaScript and then sent to the server if needed.
