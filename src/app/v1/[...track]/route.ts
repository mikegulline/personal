...
export async function GET(req: NextRequest, { params }: { params: Params }) {
  ...
  const redirectUrl: RedirectUrl = {
    ...
    mail: `mailto:${process.env.EMAIL_ADDRESS}?subject=${position}%20@%20${name}&body=Hello%20Michael,%0D%0A%0D%0AWow,%20your%20resume%20looks%20amazing%20%F0%9F%A4%98%F0%9F%8F%BB%0D%0A%0D%0AYour%20skills%20and%20background%20make%20you%20an%20excellent%20addition%20to%20the%20${name}%20team.%0D%0A%0D%0ADo%20you%20have%20a%20free%20moment%20to%20speak%20about%20the%20${position}%20role?%0D%0A%0D%0AWe%20do%20hope%20you%27ll%20join%20us,%0D%0A${name}`,
